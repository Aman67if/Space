...
const Encryption = () => {
    return (
        <div className="flex flex-row relative items-center justify-center md:min-h-screen min-h-[50vh] w-full h-full">
            ...
            <div className="flex flex-col items-center justify-center md:translate-y-[-50px] translate-y-[16px] absolute z-[20] w-auto h-auto">
            ...
            <div className="w-full flex items-start justify-center absolute z-[-2]">
